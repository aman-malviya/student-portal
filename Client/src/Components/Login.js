            ...
            <div class="overflow-hidden">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-md-6 vh-100 overflow-scroll d-flex justify-content-center align-items-center flex-row">
                        <div className="login-panel px-5">
                            <div>
                            ...
                            <button style={{'backgroundColor':'#fff'}} type="submit" className="btn w-100 shadow grey"><img alt="google" src="Assets/google.png" height="15px" />  |  Login with Google</button>
                            <button style={{'backgroundColor':'#0e76a8', 'color':'#fff'}} type="submit" className="btn mt-3 w-100 shadow"><i class="fab fa-linkedin-in"></i>  |  Login with LinkedIn</button>
                            <button style={{'backgroundColor':'#3b5998', 'color':'#fff'}} type="submit" className="btn mt-3 w-100 shadow"><i class="fab fa-facebook-f"></i>  |  Login with Facebook</button>   
